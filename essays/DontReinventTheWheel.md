...
## The Coding Wheel
Just like the wheel, being able to use someone else's code and use it as the base for your code, so you don't have to "reinvent the wheel" makes developing a new app better and faster. This base for which we can build new code from is called a design pattern. 